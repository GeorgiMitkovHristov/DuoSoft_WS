...
public class BPOSearchService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/danail/git/DuoSoft_WS/bpo.register.ws.provider/src/main/resources/bpo-register-search.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BPOSearchService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/danail/git/DuoSoft_WS/bpo.register.ws.provider/src/main/resources/bpo-register-search.wsdl");
        }
        WSDL_LOCATION = url;
    }

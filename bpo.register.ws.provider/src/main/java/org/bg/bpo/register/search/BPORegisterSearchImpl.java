...
import org.bg.bpo.register.db.convert.to.ws.response.DBEntityToWSResponse;
import org.bg.bpo.register.db.entities.schema.tmview.Mark;

/**
 * This class was generated by Apache CXF 2.7.16
 * 2015-06-29T01:22:55.143+03:00
...
public class BPORegisterSearchImpl implements BPORegisterSearch {
    ...
    public java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> getMarkByRegNum(java.lang.String regnum) { 
        LOG.info("Executing operation getMarkByRegNum with param value regnum: "+regnum);
        
        try {
    		DatabaseConnector dbConn = DatabaseConnector.getInstance();
            java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> _return = new DBEntityToWSResponse(dbConn.getMarksByRegNum(regnum), dbConn).convertToWSResponseType();
            return _return;
    ...
    public java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> getMarksByName(java.lang.String markname) { 
        ...
        try {
    		DatabaseConnector dbConn = DatabaseConnector.getInstance();
            java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> _return = new DBEntityToWSResponse(dbConn.getMarksByAppName(markname), dbConn).convertToWSResponseType();
            return _return;
        } catch (java.lang.Exception ex) {
            LOG.log(java.util.logging.Level.SEVERE, ex.getMessage(), ex);
            throw new RuntimeException(ex);
    ...
    public java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> getMarkByOwnersName(java.lang.String fname,java.lang.String sname,java.lang.String lname) { 
        ...
        try {
    		DatabaseConnector dbConn = DatabaseConnector.getInstance();
            java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> _return = new DBEntityToWSResponse(dbConn.getMarksByOwnerName(fname, sname, lname), dbConn).convertToWSResponseType();
            return _return;
        } catch (java.lang.Exception ex) {
            LOG.log(java.util.logging.Level.SEVERE, ex.getMessage(), ex);
            throw new RuntimeException(ex);
    ...
    public java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> getMarkByAppNum(java.lang.String appnum) { 
        ...
        try {
            ...
            java.util.List<bg.egov.regix.patentdepartment.TradeMarkType> _return = new DBEntityToWSResponse(marks, dbConn).convertToWSResponseType();
            return _return;
        } catch (java.lang.Exception ex) {
            LOG.log(java.util.logging.Level.SEVERE, ex.getMessage(), ex);
            throw new RuntimeException(ex);
